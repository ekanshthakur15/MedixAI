...
urlpatterns = [
    ...
    path("reports/list/treatment/<str:treatment_name>",
         MedicalReportsByTreatmentAPIView.as_view()),
    path("reports/list/<int:id>", ReportAttributesListView.as_view()),
    path("reports/detail/<int:report_id>",
         MedicalReportDetailAPIView.as_view()),
    path("report-summary/", ReportSummaryAPIView.as_view()),
    path("reports/attributes/", AttributesListByTreatment.as_view()),
    path("reports/attributes/visualisation/<str:element>",
         MedicalReportAttributeVisualisation.as_view()),
    path("treatments/", TreatmentListAPIView.as_view()),
    path("articles/", ArticleSearchAPIView.as_view(), name='article-search'),
    path("articles/recommendations/",
         ArticleRecommendationAPIView.as_view(), name='article-recommendation'),
]
